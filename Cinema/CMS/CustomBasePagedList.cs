...
namespace CMS
{
    public class CustomBasePagedList<T> : PagedListMetaData, IPagedList<T>
    {
        /// <summary>
		/// 	The subset of items contained only within this one page of the superset.s
		/// </summary>
        ...
        /// </summary>
        protected internal CustomBasePagedList()
        {
        }
        ...
        protected internal CustomBasePagedList(int pageNumber, int pageSize, int totalItemCount)
        {
            if (pageNumber < 1)
