...
namespace CMS
{
    ...
    /// <seealso cref="List{T}"/>
    [Serializable]
    public class CustomPagedList<T> : CustomBasePagedList<T>
    {
        /// <summary>
        ...
        public CustomPagedList(IQueryable<T> superset, int pageNumber, int pageSize, int totalItemCount)
        {
            if (pageNumber < 1)
        ...
        /// <exception cref="ArgumentOutOfRangeException">The specified index cannot be less than zero.</exception>
        /// <exception cref="ArgumentOutOfRangeException">The specified page size cannot be less than one.</exception>
        public CustomPagedList(IEnumerable<T> superset, int pageNumber, int pageSize, int totalItemCount)
